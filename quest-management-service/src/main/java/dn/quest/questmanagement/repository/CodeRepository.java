...
public interface CodeRepository extends JpaRepository<Code, Long>, JpaSpecificationExecutor<Code> {
     ...
     */
    List<Code> findByLevelId(Long levelId);

    /**
     * Найти коды по ID уровня с пагинацией
     */
    Page<Code> findByLevelId(Long levelId, Pageable pageable);
    ...
    List<Code> findByLevelIdOrderByTypeAndSector(@Param("levelId") Long levelId);
    ...
    @Query("SELECT c FROM Code c WHERE c.levelId = :levelId AND c.codeType = :codeType " +
           "ORDER BY c.sectorNo")
    List<Code> findByLevelIdAndCodeType(@Param("levelId") Long levelId, 
    ...
    @Query("SELECT c FROM Code c WHERE c.levelId = :levelId AND c.codeType = 'NORMAL' " +
           "ORDER BY c.sectorNo")
    List<Code> findNormalCodesByLevelId(@Param("levelId") Long levelId);
    ...
    List<Code> findBonusCodesByLevelId(@Param("levelId") Long levelId);
    ...
    List<Code> findPenaltyCodesByLevelId(@Param("levelId") Long levelId);
    ...
    Optional<Code> findNormalCodeByLevelIdAndSectorNo(@Param("levelId") Long levelId, 
    ...
    Optional<Code> findByLevelIdAndCodeValue(@Param("levelId") Long levelId, 
    ...
    List<Code> findActiveByLevelId(@Param("levelId") Long levelId);
    ...
    @Query("SELECT c FROM Code c WHERE c.levelId = :levelId AND c.active = true AND " +
           "(c.maxUsageCount IS NULL OR c.usageCount < c.maxUsageCount) " +
           "ORDER BY c.codeType, c.sectorNo")
    List<Code> findUsableCodesByLevelId(@Param("levelId") Long levelId);
    ...
    long countByLevelIdAndCodeType(@Param("levelId") Long levelId, 
                                   @Param("codeType") CodeType codeType);
    ...
    @Query("SELECT COUNT(c) > 0 FROM Code c WHERE c.levelId = :levelId AND c.sectorNo = :sectorNo " +
           "AND c.codeType = 'NORMAL'")
    boolean existsNormalCodeByLevelIdAndSectorNo(@Param("levelId") Long levelId, 
                                                @Param("sectorNo") Integer sectorNo);
    ...
    boolean existsByLevelIdAndCodeValue(@Param("levelId") Long levelId, 
                                       @Param("codeValue") String codeValue);
    ...
    Integer findMaxSectorNoByLevelId(@Param("levelId") Long levelId);
    ...
    Object[] getLevelCodeStatistics(@Param("levelId") Long levelId);
