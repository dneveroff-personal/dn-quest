...
public class QuizTelegramBot extends TelegramLongPollingBot {
    ...
    private final QuizService quizService; // Ваш сервис для работы с квизами

    public QuizTelegramBot(String botToken, QuizService quizService) {
    ...
    private void processAnswer(Long chatId, String command) {
        ...
        AnswerResult result = quizService.getAnswerResult(quizId, answerRequest, "admin");
